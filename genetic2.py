...
class Genetic:
    ...
    def __init__(self, number_cars = 2, Graph = Graph()):
        self.population = Population(number_cars)
        self.number_selected = 100
        self.number_population = 1000
